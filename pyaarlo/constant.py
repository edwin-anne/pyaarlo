...
SIP_INFO_PATH = "/hmsweb/users/devices/sipInfo/v2"
CAPABILITIES_URL = "https://myapi.arlo.com/resources/capabilities/{model}/{model}_i000.json"
WEBRTC_SIGNALING_PORT = 7443
